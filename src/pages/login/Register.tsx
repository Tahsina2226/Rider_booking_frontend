      ...
      <div className="bg-white shadow-lg rounded-2xl w-full max-w-md overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="bg-blue-600 hover:bg-blue-700 disabled:opacity-50 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 w-full font-medium text-white transition-colors disabled:cursor-not-allowed"
          >
            {isLoading ? (
          ...
          <div className="mt-8 pt-6 border-gray-200 border-t">
            <div className="gap-4 grid grid-cols-2">
              <button
                type="button"
                className="flex justify-center items-center bg-red-50 hover:bg-red-100 px-4 py-2 rounded-lg text-red-700 transition-colors"
              >
                <svg
              ...
              <button
                type="button"
                className="flex justify-center items-center bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg text-blue-700 transition-colors"
              >
                <svg
                  className="mr-2 w-5 h-5"
                  viewBox="0 0 24 24"
